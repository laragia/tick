 ...
 */
export class TickTableDataSource extends DataSource<Tick> {
  data: Tick[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: Tick[]) {
  ...
  private getSortedData(data: Tick[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        ...
        //case 'reminder': return compare(+reminder.id, +reminder.id, isAsc);
        default: return 0;
      }
    });
  }
